...
import { Automations, Device, Prisma } from '@prisma/client';
...
export class AutomationService implements OnModuleInit {
  ...
  async runAutomation(automation: Automations & {device: Device}) {
  ...
  async updateAutomation(id: string, data: Prisma.AutomationsUncheckedUpdateInput) {
    ...
    if (automation.device) this.mqttService.removeCallback(automation.device.gatewayId, id);
    await this.runAutomation(automation);
  }
